...
const config = {
  ...
  i18n: {
    defaultLocale: 'en',
    locales: ['en', 'ur'], // Adding Urdu for translation system
  },
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-organization/speckit-docusaurus-docs/edit/main/',
  ...
  plugins: [
    ...
    // Plugin for component playground
    [
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Speckit + Docusaurus',
        logo: {
          alt: 'Speckit + Docusaurus Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
          ...
          {
            href: 'https://github.com/your-organization/speckit-docusaurus-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        links: [
          {
            ...
            items: [
              ...
              {
                label: 'Speckit Integration',
                to: '/docs/speckit-integration',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Speckit + Docusaurus Project. Built with Docusaurus.`,
      },
      prism: {
